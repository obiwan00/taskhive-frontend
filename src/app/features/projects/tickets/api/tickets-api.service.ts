...
export class TicketsApiService {
  ...
  getDetails(projectId: string, ticketId: string) {
    return this.http.get<TicketDetails>(`/api/projects/${projectId}/tickets/${ticketId}`);
  }

  create(projectId: string, data: CreateTicket) {
    return this.http.post<TicketBrief>(`/api/projects/${projectId}/tickets`, data);
  }
  ...
  delete(projectId: string, ticketId: string) {
    return this.http.delete<void>(`/api/projects/${projectId}/tickets/${ticketId}`);
  }
}
